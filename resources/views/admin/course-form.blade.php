        ...
        <div class="container-fluid">
            ...
            <div class="box_general padding_bottom">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Judul Materi @include(
                                'admin.components.miniComponents.required-fill'
                            )</label>
                            <input type="text" name="title" class="form-control title-course" placeholder="Judul Materi"
            ...
            <div class="box_general padding_bottom">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Tujuan Pembelajaran @include(
                                'admin.components.miniComponents.required-fill'
                            )</label>
                            @include(
                                'admin.components.miniComponents.ckeditor',
                                [
                                    'name' => 'description',
                                    'defaultValue' => isset($data)
                                        ? $data['description']
                                        : old('description'),
                                ]
                            )
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <label>Mata Pelajaran @include(
                                'admin.components.miniComponents.required-fill'
                            )</label>
                            @include(
                                'admin.components.miniComponents.select2',
                                [
                                    'name' => 'categoryId',
            ...
            <!-- /box_general-->
            @include('admin.components.miniComponents.editor', [
                'id' => 'description',
                'title' => 'Tulis Materi',
                'name' => 'content',
            ...
            <p><button id="btn-save" class="btn_1 medium">Simpan Materi</button></p>
        </div>
        {{-- </form> --}}
