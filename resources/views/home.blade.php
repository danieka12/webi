...
<body>
    ...
    <div id="page">
        ...
        <header class="header menu_2">
            ...
            <div id="logo">
                <a href="index.html">
                    <image src="image/logo.png" width="149" height="42" alt="">
                </a>
            </div>
            <ul id="top_menu">
                        ...
                        <div class="box_grid">
                            <figure>
                                ...
                                <a href="course-detail.html">
                                    ...
                                    <image src="http://via.placeholder.com/800x533/ccc/fff/course__list_1.jpg" class="image-fluid" alt="">
                                </a>
                    ...
                    <div class="item">
                        <div class="box_grid">
                            <figure>
                                <a href="#0" class="wish_bt"></a>
                                <a href="course-detail.html">
                                    <image src="http://via.placeholder.com/800x533/ccc/fff/course__list_2.jpg" class="image-fluid" alt="">
                                </a>
                    ...
                    <div class="item">
                        <div class="box_grid">
                            <figure>
                                <a href="#0" class="wish_bt"></a>
                                <a href="course-detail.html">
                                    <image src="http://via.placeholder.com/800x533/ccc/fff/course__list_3.jpg" class="image-fluid" alt="">
                                </a>
                    ...
                    <div class="item">
                        <div class="box_grid">
                            <figure>
                                <a href="#0" class="wish_bt"></a>
                                <a href="course-detail.html">
                                    <image src="http://via.placeholder.com/800x533/ccc/fff/course__list_4.jpg" class="image-fluid" alt="">
                                </a>
                    ...
                    <div class="item">
                        <div class="box_grid">
                            <figure>
                                <a href="#0" class="wish_bt"></a>
                                <a href="course-detail.html">
                                    <image src="http://via.placeholder.com/800x533/ccc/fff/course__list_5.jpg" class="image-fluid" alt="">
                                </a>
                    ...
                    <div class="item">
                        <div class="box_grid">
                            <figure>
                                <a href="#0" class="wish_bt"></a>
                                <a href="course-detail.html">
                                    <image src="http://via.placeholder.com/800x533/ccc/fff/course__list_6.jpg" class="image-fluid" alt="">
                                </a>
                                <div class="price">$54</div>
                                <div class="preview"><span>Preview course</span></div>
                            </figure>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 wow" data-wow-offset="150">
                        <a href="#0" class="grid_item">
                            <figure class="block-reveal">
                                ...
                                <image src="http://via.placeholder.com/800x533/ccc/fff/course_1.jpg" class="image-fluid" alt="">
                                    <div class="info">
                    ...
                    <div class="col-lg-4 col-md-6 wow" data-wow-offset="150">
                        <a href="#0" class="grid_item">
                            <figure class="block-reveal">
                                <div class="block-horizzontal"></div>
                                <image src="http://via.placeholder.com/800x533/ccc/fff/course_2.jpg" class="image-fluid" alt="">
                                    <div class="info">
                    ...
                    <div class="col-lg-4 col-md-6 wow" data-wow-offset="150">
                        <a href="#0" class="grid_item">
                            <figure class="block-reveal">
                                <div class="block-horizzontal"></div>
                                <image src="http://via.placeholder.com/800x533/ccc/fff/course_3.jpg" class="image-fluid" alt="">
                                    <div class="info">
                                        <small><i class="ti-layers"></i>23 Programmes</small>
                                        <h3>Architecture</h3>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow" data-wow-offset="150">
                        <a href="#0" class="grid_item">
                            <figure class="block-reveal">
                                <div class="block-horizzontal"></div>
                                <image src="http://via.placeholder.com/800x533/ccc/fff/course_4.jpg" class="image-fluid" alt="">
                                    <div class="info">
                                        <small><i class="ti-layers"></i>23 Programmes</small>
                    ...
                    <div class="col-lg-4 col-md-6 wow" data-wow-offset="150">
                        <a href="#0" class="grid_item">
                            <figure class="block-reveal">
                                <div class="block-horizzontal"></div>
                                <image src="http://via.placeholder.com/800x533/ccc/fff/course_5.jpg" class="image-fluid" alt="">
                                    <div class="info">
                                        <small><i class="ti-layers"></i>23 Programmes</small>
                    ...
                    <div class="col-lg-4 col-md-6 wow" data-wow-offset="150">
                        <a href="#0" class="grid_item">
                            <figure class="block-reveal">
                                <div class="block-horizzontal"></div>
                                <image src="http://via.placeholder.com/800x533/ccc/fff/course_6.jpg" class="image-fluid" alt="">
                                    <div class="info">
                                        <small><i class="ti-layers"></i>23 Programmes</small>
                                        <h3>Medical</h3>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <a class="box_news" href="#0">
                                <figure>
                                    <image src="http://via.placeholder.com/500x333/ccc/fff/news_home_1.jpg" alt="">
                        ...
                        <div class="col-lg-6">
                            <a class="box_news" href="#0">
                                <figure>
                                    <image src="http://via.placeholder.com/500x333/ccc/fff/news_home_2.jpg" alt="">
                                        <figcaption><strong>28</strong>Dec</figcaption>
                                </figure>
                                <ul>
                                    <li>Jhon Doe</li>
                        ...
                        <div class="col-lg-6">
                            <a class="box_news" href="#0">
                                <figure>
                                    <image src="http://via.placeholder.com/500x333/ccc/fff/news_home_3.jpg" alt="">
                                        <figcaption><strong>28</strong>Dec</figcaption>
                                </figure>
                                <ul>
                                    <li>Luca Robinson</li>
                        ...
                        <div class="col-lg-6">
                            <a class="box_news" href="#0">
                                <figure>
                                    <image src="http://via.placeholder.com/500x333/ccc/fff/news_home_4.jpg" alt="">
                                        <figcaption><strong>28</strong>Dec</figcaption>
                                </figure>
                                <ul>
