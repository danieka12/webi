@extends('components.native', ['title' => 'Ambil Materi', 'id' => 'admission_bg'])
...
@section('content')
    ...
    <div id="form_container" class="clearfix">
        <figure>
            <a href="index.html"><img src={{ asset('images/logo.png') }} width="149" height="42" alt=""></a>
        </figure>
        <div id="wizard_container">
            ...
            <form name="example-1" id="wrapped" method="POST">
                ...
                <div id="middle-wizard">
                    <div class="step">
                        <div id="intro">
                            <figure><img src={{ asset('images/wizard_intro_icon.svg') }} alt=""></figure>
                    ...
                    <div class="submit step">
                        ...
                        <div class="form-group radio_input">
                            <label><input type="checkbox" value="Management" name="preferences[]"
                                    class="icheck">Management adn Business</label>
                        </div>
                        <div class="form-group radio_input">
                        ...
                        <div class="form-group radio_input">
                            <label><input type="checkbox" value="Litteratture" name="preferences[]"
                                    class="icheck">Litteratture: Poetry</label>
                        </div>
                        <div class="form-group radio_input">
                        ...
                        <div class="form-group radio_input">
                            <label><input type="checkbox" value="Architecture" name="preferences[]"
                                    class="icheck">Architecture</label>
                        </div>
                        ...
                        <div class="form-group terms">
                            ...
                            <label>Please accept <a href="#" data-bs-toggle="modal" data-bs-target="#terms-txt">terms and
                                    conditions</a> ?</label>
                        </div>
                    </div>
                    <!-- /step-->
